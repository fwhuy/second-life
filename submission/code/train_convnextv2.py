...
Typical usage:
  python train_convnextv2.py                 # train, then prompt for HF upload
  python train_convnextv2.py --no-upload     # train only, no upload
  python train_convnextv2.py --upload-only   # upload an existing checkpoint
  python train_convnextv2.py --repo-id you/waste-convnextv2 --private
